...
export default function Shoulder({ onShoulderSelect, isOpen, onAccordionToggle  }) {
  ...
  return (
    <>
      <li className={`shoulder-type ${isOpen ? "active" : ""}`}>
        ...
        <path d="M372 2367 l-372 -372 230 -230 230 -230 123 123 c67 67 124 122 127
        ...
        <path d="M463 2347 c-276 -276 -323 -327 -323 -351 0 -25 25 -55 148 -178 107
              ...
              <div className="wraper shoulder-size">
                ...
                <div className="customize-info">
                  {ShoulderImages.map((ShoulderTypes) => (
                    ...
                    >
                      <div className={`info ${selectedShoulder === ShoulderTypes.id ? "highlightShoulder" : ""}`}>
                        <figure>
                          <img
                            key={ShoulderTypes.id}
