  ...
  return (
    <>
      <li className={`add-images ${isOpen ? "active" : ""}`}>
        <h3 onClick={handleTab} className="forDesktop">Add Images</h3>
        <h3 onClick={() => handleTab("add-images-layer")} className="forMob"><svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="200.000000pt" height="200.000000pt" viewBox="0 0 200.000000 200.000000" preserveAspectRatio="xMidYMid meet">
        <metadata>
