...
function tempRightSide(){
  ...
  {
    let imageObj2 = new Image();
    imageObj2.src = jQuery('.choosenStripe').attr('rightside-stripe-v');
    imageObj2.onload = function() {
...
function tempLeftSide(){
  ...
  {
    let imageObj2 = new Image();
    imageObj2.src = jQuery('.choosenStripe').attr('leftside-stripe-v');
    imageObj2.onload = function() {
    ctxTemp.drawImage(imageObj2, 0, 0);
...
//  jQuery(".selected-colors").mouseout(function($){
...
//  $("#number-bend-front").change(function() {

//   $('#resize-drag1').removeClass();
//   $('#resize-drag4').removeClass();

//   let settext = jQuery(this).val();
//   let fontstyle = $('#resize-drag1').attr('font-id');

//   if(settext == 'full-rev-arc')
//     {
//       let word = $('#text-string').val();
//       let len = word.length;
//       var modified = "";
//       for (var i = 0; i < len; i++) {
//         modified += "<span class='full-rev-arc'>" + word[i] + "</span>";
//       }
//       $('#resize-drag1').addClass('fs-3-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('fs-3-'+len);
//       $('#resize-drag4').html(modified);

//       $('.full-rev-arc', '#resize-drag1').css("font-family", fontstyle);
//       $('.full-rev-arc', '#resize-drag4').css("font-family", fontstyle);
...
//       }
//       $('#resize-drag1').addClass('va-5-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('va-5-'+len);
//       $('#resize-drag4').html(modified);

//       $('.vertical-arc', '#resize-drag1').css("font-family", fontstyle);
//       $('.vertical-arc', '#resize-drag4').css("font-family", fontstyle);
//     } 
...
//       }
//       $('#resize-drag1').addClass('bv-6-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('bv-6-'+len);
//       $('#resize-drag4').html(modified);

//       $('.bottom-vertical', '#resize-drag1').css("font-family", fontstyle);
//       $('.bottom-vertical', '#resize-drag4').css("font-family", fontstyle);
//     } 
...
//       }
//       $('#resize-drag1').addClass('iv-7-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('iv-7-'+len);
//       $('#resize-drag4').html(modified);

//       $('.inverse-vertical', '#resize-drag1').css("font-family", fontstyle);
//       $('.inverse-vertical', '#resize-drag4').css("font-family", fontstyle);
//     } 
...
//       }
//       $('#resize-drag1').addClass('cb-8-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('cb-8-'+len);
//       $('#resize-drag4').html(modified);

//       $('.center-bulge', '#resize-drag1').css("font-family", fontstyle);
//       $('.center-bulge', '#resize-drag4').css("font-family", fontstyle);
//     } 
...
//       }
//       $('#resize-drag1').addClass('sd-9-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('sd-9-'+len);
//       $('#resize-drag4').html(modified);

//       $('.san-diego', '#resize-drag1').css("font-family", fontstyle);
//       $('.san-diego', '#resize-drag4').css("font-family", fontstyle);
//     } 
...
//       }
//       $('#resize-drag1').addClass('ha-10-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('ha-10-'+len);
//       $('#resize-drag4').html(modified);

//       $('.half-asleep-arc', '#resize-drag1').css("font-family", fontstyle);
//       $('.half-asleep-arc', '#resize-drag4').css("font-family", fontstyle);
//     } 
...
//       }
//       $('#resize-drag1').addClass('bi-11-'+len);
//       $('#resize-drag1').html(modified);

//       $('#resize-drag4').addClass('bi-11-'+len);
//       $('#resize-drag4').html(modified);

//       $('.breathing-in', '#resize-drag1').css("font-family", fontstyle);
//       $('.breathing-in', '#resize-drag4').css("font-family", fontstyle);
//     } 
//     else {
//       $('#resize-drag1').removeClass();
//       $('#resize-drag1').addClass('arc');
//       $('#resize-drag1').addClass(settext);

//       $('#resize-drag4').removeClass();
//       $('#resize-drag4').addClass('arc');
//       $('#resize-drag4').addClass(settext);
//     }
...
//     nameby = 'rotate(-11deg)';
//   }
//    $('#resize-drag1').css('transform', nameby);



//   let selectedItem2 = jQuery('#resize-drag4').attr('class');
//   let nameby2 = '';          
//   if(selectedItem2 == 'arc trajectory')
//   {
//     nameby2 = 'rotate(11deg)';
//   }
//   if(selectedItem2 == 'arc gravity')
//   {
//     nameby2 = 'rotate(-11deg)';
//   }
//    $('#resize-drag4').css('transform', nameby2);
...
jQuery('.customize-view__image figure').attr('id', 'html-content-holder');
document.getElementById("saveunii").addEventListener("click", function() {
  html2canvas(document.getElementById("html-content-holder")).then(function (canvas) {			
    var anchorTag = document.createElement("a");
      document.body.appendChild(anchorTag);
      document.getElementById("main-preview").appendChild(canvas);
...
if(checkId3){
  ...
  if(settext3 == 'gravity')
  {
    ...
    $('.gravity', '#resize-drag2').css("font-family", fontstyle3);
  } 
  else if(settext3 == 'trajectory')
  {
    ...
    $('.trajectory', '#resize-drag2').css("font-family", fontstyle3);
  } 
  else if(settext3 == 'straight-line')
  {
    ...
    $('.straight-line', '#resize-drag2').css("font-family", fontstyle3);
  } 
...
document.getElementById('browse-image').onchange = function(e) {
  ...
  html2canvas(document.getElementById("html-content-holder")).then(function (canvas) {
    ...
    $('#tcanvas').append('<div class="resize-drag-img"><img id="imginimg"src="'+img.src+'"></div>');
    $('#tcanvas').css('z-index', 1);
    $('#tcanvas3').css('z-index', 0);
  });
};
